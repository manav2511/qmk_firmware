...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE_QWERTY] = LAYOUT_all( /* Base QWERTY */
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11, KC_F12,   KC_DEL,           TG(_BASE_COLEMAK_DH),
        ...
        KC_LCTL, KC_LGUI, SC_LAPO,                   KC_SPC,                             SC_RAPC, MO(_SECOND),KC_RCTL,        KC_LEFT, KC_DOWN, KC_RGHT),

    [_FIRST] = LAYOUT_all( /* WASD/↑←↓→ */
        ...
        _______, _______, _______,                   _______,                            _______,MO(_SECOND),_______,          KC_A,    KC_S,    KC_D),

    [_SECOND] = LAYOUT_all( /* RGB */
        ...
        _______, _______,TG(_FIRST),_______, _______, _______, _______, _______, KC_INS, DF(_BASE_COLEMAK_DH),KC_PSCR,_______, _______,RGB_MOD, _______,
    ...
    [_BASE_COLEMAK_DH] = LAYOUT_all( /* Base COLEMAK-DH */
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11, KC_F12,   KC_DEL,           TG(_BASE_COLEMAK_DH),
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,KC_EQL,   KC_BSPC,          KC_HOME,
        KC_TAB,  KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,    KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, KC_LBRC,KC_RBRC,  KC_BSLS,          KC_PGUP,
        QK_LEAD, KC_A,    KC_R,    KC_S,    KC_T,    KC_G,    KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT,KC_NUHS,  KC_ENT,           KC_PGDN,
        KC_LSFT, KC_NUBS, KC_X,    KC_C,    KC_D,    KC_V,    KC_Z,    KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT, KC_UP,   KC_END,
        KC_LCTL, KC_LGUI, SC_LAPO,                   KC_SPC,                             SC_RAPC, MO(_SECOND),KC_RCTL,        KC_LEFT, KC_DOWN, KC_RGHT),
};
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [_BASE_QWERTY] = { ENCODER_CCW_CW(KC_VOLU, KC_VOLD) },
    [_FIRST] = { ENCODER_CCW_CW(RGB_VAI, RGB_VAD) },
    [_SECOND] = { ENCODER_CCW_CW(KC_VOLU, KC_VOLD) },
    [_BASE_COLEMAK_DH] = { ENCODER_CCW_CW(KC_VOLU, KC_VOLD) },
};
#endif
